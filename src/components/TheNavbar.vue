<template>
  <div
    class="fixed bottom-8 left-1/2 -translate-x-1/2 z-50 w-auto px-4 max-w-full overflow-x-auto no-scrollbar"
  >
    <nav
      v-motion
...
const navItems = [
  ...
  { icon: ExternalLink, label: "Registro", href: "/registro", primary: true },
];
</script>
