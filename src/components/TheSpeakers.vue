  ...
  <div class="bg-[#0B0F1A] relative overflow-hidden">
    <section id="speakers" class="py-32 md:py-48 relative border-t border-white/5">
      ...
      <div class="absolute inset-0 z-0">
        ...
        <div class="absolute bottom-0 left-1/4 w-[600px] h-[600px] bg-[#00F5D4]/5 rounded-full blur-[150px] pointer-events-none"></div>
      </div>
      ...
      <div class="max-w-7xl mx-auto px-6 lg:px-4 xl:px-0 relative z-10">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 lg:gap-5 w-full">
          <div v-for="(speaker, index) in speakers" :key="'speaker-' + index" v-motion
            :initial="{ opacity: 0, y: 30 }"
            :visibleOnce="{ opacity: 1, y: 0, transition: { duration: 400, delay: (index % 5) * 100 } }"
            ...
            <!-- Image Header -->
            <div class="relative w-full aspect-[4/5] overflow-hidden bg-black/60">
              <div class="absolute inset-0 bg-gradient-to-t from-[#121A2F] via-[#121A2F]/20 to-transparent z-10 transition-opacity duration-500 group-hover:opacity-60"></div>
              <img :src="speaker.img" :alt="speaker.name"
                ...
                @error="(e) => ((e.target as HTMLImageElement).src = 'https://images.unsplash.com/photo-1560250097-0b93528c311a?q=80&w=600&auto=format&fit=crop')" loading="lazy" />
              <!-- Tag -->
...
const speakers = [
  ...
  },
  {
    ...
    quote: 'La integración de cadenas globales requiere una visión de futuro y puesta en la innovación.',
    tag: 'Innovación'
  },
  {
    img: Sigfredo,
    ...
    quote: 'Impulsa cultivos sostenibles y de cero residuos para mejorar la agricultura en la Tierra.',
    tag: 'Ag-Tech'
  },
  {
    img: Stuart,
    ...
    quote: 'La automatización de ecosistemas controlados revolucionará la matriz productiva del norte.',
    tag: 'Ing. Espacial'
  }
]
</script>
